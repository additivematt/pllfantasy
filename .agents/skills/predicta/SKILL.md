...
| **Optimization** | `06_optimize_lineups.py` | Optimal lineup (see [coulda](../coulda/SKILL.md)) |
...
> [!NOTE]
> For the mathematical rationale of retiring legacy EV/Boom% models, deprecated stacked correlation stacking optimization formulas, and pre-leakage baseline backtest tables, see [Predicta Historical Design Decisions & Archived Models](file:///f:/Google%20Drive/Documents/Hobbies/Lacrosse/PLL%20fantasy/scripts/.agents/skills/predicta/references/design_history.md).
...
Detailed optimizer logic is mapped out in the [coulda](../coulda/SKILL.md) skill.
...
See the [coulda](../coulda/SKILL.md) skill for roster optimization commands and strategies.
