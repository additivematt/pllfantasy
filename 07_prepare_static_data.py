...
def main():
    ...
    predictions_folder = os.path.join(SCRIPTS_DIR, "predicta", "predictions")
    csv_pattern = os.path.join(predictions_folder, "week*_predictions.csv")
    ...
    for filepath in csv_files:
        ...
        if match:
            ...
            reg_filepath = os.path.join(predictions_folder, f"week{week}_{year}_predictions_regression.csv")
            ...
            if True:
                try:
                    ...
                    df_hist = opt_lineups.load_historical_data(year, week, SCRIPTS_DIR)
                    tier_avgs = opt_lineups.calculate_tier_averages(df_hist)
                    ...
                    if df_reg is not None:
                        ...
                        df_merged = df_class[merged_cols].copy()
