...
def main():
    ...
    # Define tasks: 2025 weeks 1-14 (excluding 6) + 2026 weeks 1-5
    tasks = []
    ...
    for i, (year, week) in enumerate(tasks, 1):
        ...
        pred_cmd = [sys.executable, "02_predict_probabilities.py",
        ...
        sim_cmd = [sys.executable, "04_simulate_monte_carlo.py",
                  "--year", str(year), "--week", str(week),
